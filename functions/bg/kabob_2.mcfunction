...
give @s firework_star[minecraft:custom_model_data=134,minecraft:max_damage=3,minecraft:damage=1,minecraft:max_stack_size=1,food={nutrition:6,saturation:10.5,eat_seconds:2.4},minecraft:item_name='{"text":"Kabob"}']